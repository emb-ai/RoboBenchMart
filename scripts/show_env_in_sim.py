...
def parse_args():
    ...
    parser.add_argument("--assets_dir", default=ASSETS_PATH, help="Путь к assets")
    parser.add_argument("--style_id", type=int, default=0, help="Style id (0-11)")
    parser.add_argument("--mapping_file", default=f'{ASSETS_PATH}/connect.json', help="Путь к mapping_file (опционально)")
